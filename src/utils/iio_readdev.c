...
#ifdef _DEBUG
#ifdef _WIN64
#pragma comment(lib, "../build/Debug_x64/libiio.lib")
#else
#pragma comment(lib, "../build/Debug_x86/libiio.lib")
#endif
#else
#ifdef _WIN64
#pragma comment(lib, "../build/Release_x64/libiio.lib")
#else
#pragma comment(lib, "../build/Release_x86/libiio.lib")
#endif
#endif
#ifdef _WIN64
...
void** __cdecl __current_exception(void){ return NULL; }
void** __cdecl __current_exception_context(){ return NULL; };
